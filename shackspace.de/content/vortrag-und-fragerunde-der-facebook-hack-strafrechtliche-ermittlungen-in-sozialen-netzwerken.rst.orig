Vortrag und Fragerunde: Der Facebook-Hack - Strafrechtliche Ermittlungen in Sozialen Netzwerken
###############################################################################################
...
|shack|\ Am **Samstag** den **20. April 2013** um **19:30 Uhr** lädt
shackspace zu einem für alle Netzaffinen interessanten Vortrag mit
anschließender Frage- und Plauderrunde.
...
| *Zur Person:*
|  Sierk Hamann ist Jurist aus Tübingen und unternahm seine ersten
Reisen im Cyberspace mit `NCSA
Mosaic <http://de.wikipedia.org/wiki/NCSA_Mosaic>`__. Er ist seit dem
Jahr 2000 als Richter und
`Staatsanwalt <http://de.wikipedia.org/wiki/Staatsanwalt>`__ tätig. Die
Ursprünge seiner wissenschaftlichen Arbeit liegen im
`Verfassungsrecht <http://de.wikipedia.org/wiki/Verfassungsrecht>`__ mit
besonderem Schwerpunkt auf Telekommunikationsfreiheiten &
`Informationeller
Selbstbestimmung <http://de.wikipedia.org/wiki/Informationelle_Selbstbestimmung>`__.

| *Zum Event:
*\ **Eintritt frei!** (*Spenden an shack e.V. sind gerne gesehen*) Jeder
ist willkommen!  Um `formlose
Anmeldung <http://doodle.com/yk4p7dvaiy9qqfdw>`__ (Doodle) wird gebeten.
